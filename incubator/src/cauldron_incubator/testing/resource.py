...
from cauldron_incubator.testing.scenario import Expectations, User
from cauldron_incubator.testing.user import UserTestScenario
...
if TYPE_CHECKING:
    ...
    from cauldron_incubator.resources.models import ReadModelType
...
class BaseTestResourceCrud[ModelT: Resource]:
    ...
    def scenario_fixture(
        self, subtests: SubTests, app: CauldronHTTP
