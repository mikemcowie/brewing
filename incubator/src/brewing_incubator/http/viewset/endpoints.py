...
Viewsets are brewing's basic entrypoint for handling HTTP requests.
...
from brewing_incubator.http.viewset import const
...
if TYPE_CHECKING:
    ...
    from brewing_incubator.http import APIRouter
...
class Endpoint:
    ...
    def _method(self, wrappedmethod: HTTPMethod, *args: Any, **kwargs: Any):
        ...
        def decorator(func: Callable[..., Any]):
            ...
            func.__dict__[const.BREWING_ENDPOINT_PARAMS] = EndpointParameters(
                path=path,
