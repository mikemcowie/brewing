...
from brewing_incubator.auth.models import User
from brewing_incubator.auth.users import user
from brewing_incubator.db import session
from brewing_incubator.exceptions import Unauthorized
from brewing_incubator.http import Depends, Path, status
...
from brewing_incubator.http.viewset.base import PathParameterPlaceholder
from brewing_incubator.resources.models import (
    AccessLevel,
    Resource,
    ResourceAccessItem,
)
from brewing_incubator.resources.repo import (
    CrudRepository,
)
    ...
    def setup_endpoints(self):
        for attr in dir(self):
            ...
            params: EndpointParameters | None = getattr(
                item, const.BREWING_ENDPOINT_PARAMS, None
            )
