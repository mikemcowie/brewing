...
from brewing_incubator.testing.scenario import Expectations, User
from brewing_incubator.testing.user import UserTestScenario
...
if TYPE_CHECKING:
    ...
    from brewing_incubator.resources.models import ReadModelType
...
class BaseTestResourceCrud[ModelT: Resource]:
    ...
    def scenario_fixture(
        self, subtests: SubTests, app: BrewingHTTP
