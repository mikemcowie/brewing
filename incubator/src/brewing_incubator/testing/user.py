...
from brewing_incubator.testing.scenario import Expectations, TestScenario, User
...
class UserTestScenario:
    def __init__(self, subtests: SubTests, app: BrewingHTTP):
...
class BaseTestUser:
    @pytest.fixture
    def scenario(self, subtests: SubTests, app: BrewingHTTP) -> UserTestScenario:
