...
from brewing.db import get_session
from brewing.db.base import Base
...
class Repository[ModelT: Base]:
    ...
    async def get(self, lookup: int, /) -> ModelT:
    ...
    async def update(self, lookup: int, **update: Any) -> ModelT | None:
        """Retrieve an item by its primary_key."""
        async with get_session() as session:
    ...
    async def delete(self, lookup: int, /) -> None:
